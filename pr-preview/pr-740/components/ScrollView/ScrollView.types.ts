...
export type ScrollViewAutoScroll = 'always' | 'detectEnd' | 'off';

export type ScrollViewDirection = Layout;

/**
 * Props of the `ScrollView` component.
 */
export type ScrollViewProps = HTMLAttributes<HTMLDivElement> & {
   ...
   */
  autoScroll?: ScrollViewAutoScroll;
  /**
...
/**
 * Position difference of the scrolled content relative to the viewport, in pixels.
 */
export type ElementsPositionDifference = {
  bottom: number;
  left: number;
  right: number;
  top: number;
