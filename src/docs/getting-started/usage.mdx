...
in large scale. There are two global CSS layers:

- **Theme:** a collection of hundreds of CSS custom properties that define the
  look of your app. See [Theming](/customize/theming) for more.
...
[inspired by Bootstrap](https://getbootstrap.com/docs/4.5/css-helpers/), so if you
are familiar with Bootstrap, you will feel at home here.

---

Next: [Browsers & Devices →](/getting-started/browsers-and-devices)
