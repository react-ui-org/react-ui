...
Responsive display utility classes enable to change the `display` CSS property,
...
👉 It's perfectly OK to hide the content with the `.d-none` utility class. Just
...
Next: [Spacing →](/utilities/spacing)
