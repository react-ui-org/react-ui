...
To use the Toolbar component, you need to import it first:
...
- Use the Toolbar layout **only for [inline elements](https://developer.mozilla.org/en-US/docs/Web/HTML/Inline_elements)**
  ...
  layouts, consider using rather [spacing utilities](/utilities/spacing) or the
...
Next: [Animation →](/helpers/animation)
