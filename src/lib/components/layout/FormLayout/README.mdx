...
To use the FormLayout component, you need to import it first:
...
the `md` viewport size onward, and it forces the horizontal layout on the
fields.
...
available) can be easily [customized](/getting-started/theming) with CSS custom
properties.
