          ...
          <ToolbarGroup align="baseline">
            ...
            <ToolbarItem>
              <ButtonGroup aria-labelledby="word-wrapping-options-label">
                <Button
                  color={wordWrapping === 'normal' ? 'selected' : 'primary'}
                  label="normal"
                  onClick={() => setWordWrapping('normal')}
                />
                <Button
                  color={wordWrapping === 'long-words' ? 'selected' : 'primary'}
                  label="long-words"
                  onClick={() => setWordWrapping('long-words')}
                />
                <Button
                  color={wordWrapping === 'anywhere' ? 'selected' : 'primary'}
                  label="anywhere"
          ...
          <ToolbarGroup align="baseline">
            ...
            <ToolbarItem>
              <ButtonGroup aria-labelledby="hyphens-options-label">
                <Button
                  color={hyphens === 'none' ? 'selected' : 'primary'}
                  label="none"
                  onClick={() => setHyphens('none')}
                />
                <Button
                  color={hyphens === 'auto' ? 'selected' : 'primary'}
                  label="auto"
                  onClick={() => setHyphens('auto')}
                />
                <Button
                  color={hyphens === 'manual' ? 'selected' : 'primary'}
                  label="manual"
