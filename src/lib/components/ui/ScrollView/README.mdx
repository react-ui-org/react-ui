...
import {
  TranslatedScrollView as ScrollView,
  ScrollView as ParsableScrollView,
} from './ScrollView'

## Basic Usage

To use the ScrollView component, you need to import it first:
...
<Props of={ParsableScrollView} />

---

Next: [SelectField →](/components/ui/select-field)
