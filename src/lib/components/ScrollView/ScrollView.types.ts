...
export interface CSSProperties {
  '--rui-local-end-shadow-background'?: string;
  '--rui-local-end-shadow-direction'?: string;
  '--rui-local-end-shadow-initial-offset'?: string;
  '--rui-local-end-shadow-size'?: string;
  '--rui-local-next-arrow-color'?: string;
  '--rui-local-next-arrow-initial-offset'?: string;
  '--rui-local-prev-arrow-color'?: string;
  '--rui-local-prev-arrow-initial-offset'?: string;
  '--rui-local-start-shadow-background'?: string;
  '--rui-local-start-shadow-direction'?: string;
  '--rui-local-start-shadow-initial-offset'?: string;
  '--rui-local-start-shadow-size'?: string;
}
...
export interface ScrollViewProps {
   ...
   */
  nextArrowElement?: React.ReactNode;
  /**
   ...
   */
  prevArrowElement?: React.ReactNode;
  /**
