          ...
          <ToolbarGroup align="baseline">
            ...
            <ToolbarItem>
              <ButtonGroup aria-labelledby="alignment-label">
                <Button
                  color={alignment === 'top' ? 'selected' : 'primary'}
                  label="top"
                  onClick={() => setAlignment('top')}
                />
                <Button
                  color={alignment === 'middle' ? 'selected' : 'primary'}
                  label="middle"
                  onClick={() => setAlignment('middle')}
                />
                <Button
                  color={alignment === 'bottom' ? 'selected' : 'primary'}
                  label="bottom"
                  onClick={() => setAlignment('bottom')}
                />
                <Button
                  color={alignment === 'baseline' ? 'selected' : 'primary'}
                  label="baseline"
          ...
          <ToolbarGroup align="baseline">
            ...
            <ToolbarItem>
              <ButtonGroup aria-labelledby="justification-label">
                <Button
                  color={justification === 'start' ? 'selected' : 'primary'}
                  label="start"
                  onClick={() => setJustification('start')}
                />
                <Button
                  color={justification === 'center' ? 'selected' : 'primary'}
                  label="center"
                  onClick={() => setJustification('center')}
                />
                <Button
                  color={justification === 'end' ? 'selected' : 'primary'}
                  label="end"
                  onClick={() => setJustification('end')}
                />
                <Button
                  color={justification === 'space-between' ? 'selected' : 'primary'}
                  label="space-between"
